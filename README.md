...
[![Go Reference](https://pkg.go.dev/badge/gopkg.in/lallij/auth0.v1.svg)](https://pkg.go.dev/gopkg.in/lallij/auth0.v1)
...
Reference documentation can be found at [pkg.go.dev](https://pkg.go.dev/gopkg.in/lallij/auth0.v1). For more information about [Auth0](http://auth0.com/) please visit the [Auth0 Docs](http://docs.auth0.com/) page.
